...
namespace QuickGraph.Collections
{
    ...
    public class BinaryHeap<TPriority, TValue>
        : IEnumerable<KeyValuePair<TPriority, TValue>>, IEnumerable<TValue>
    {
        ...
        public KeyValuePair<TPriority, TValue> RemoveMinimum()
        {
            ...
            KeyValuePair<TPriority, TValue> min = this.items[0];
        ...
        //Version tracking has been disabled because I don't need the object to be frozen while iterating
        //as it's only used for debug output.

        struct Enumerator : IEnumerator<KeyValuePair<TPriority, TValue>>, IEnumerator<TValue>
        {
