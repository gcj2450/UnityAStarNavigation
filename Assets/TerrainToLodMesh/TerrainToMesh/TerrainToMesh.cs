...
public class TerrainToMesh : ScriptableObject
{
    ...
    static void Init()
    {
        ...
        int vertexCountScale = 4;       // [dev] ��������ϡ�� vertexCountScale*vertexCountScale ��
        ...
        Vector2 uvScale = new Vector2(1f / (w - 1f), 1f / (h - 1f)) * vertexCountScale * (size.x / terrainData.splatPrototypes[0].tileSize.x);     // [dev] �˴������⣬��ÿ��ͼƬ��С��һ��������⡣�պ����

        w = (w - 1) / vertexCountScale + 1;
        h = (h - 1) / vertexCountScale + 1;
        Vector3[] vertices = new Vector3[w * h];
        Vector2[] uvs = new Vector2[w * h];
        Vector4[] alphasWeight = new Vector4[w * h];            // [dev] ֻ֧��4��ͼƬ
        ...
        mesh.tangents = alphasWeight;       // �����������ı���д�뵽������
