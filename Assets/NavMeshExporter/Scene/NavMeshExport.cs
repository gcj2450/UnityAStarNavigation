...
public class NavMeshExport : MonoBehaviour
{
    ...
    private static void Export()
    {
        ...
        string fileName = Application.dataPath + "/NavMeshExporter/navmesh/" + baseName + ".obj";
    ...
    private static void ExportNavData(GameObject obj)
    {
        ...
        using (StreamWriter sw = new StreamWriter(Application.dataPath + "/NavMeshExporter/navmesh/" + obj.name + ".lua"))
        {
