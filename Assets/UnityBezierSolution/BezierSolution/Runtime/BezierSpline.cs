...
namespace BezierSolution
{
	...
	public partial class BezierSpline : MonoBehaviour, IEnumerable<BezierPoint>
	{
		...
		/// <summary>
		/// 根据分辨率获取点列表，FromBezierCanvas
		/// </summary>
		/// <param name="segments"></param>
		/// <returns></returns>
        public List<Vector3> GetPoints(int segments)
        {
            ...
            {
                var p0 = endPoints[i - 1].position;
                var p1 = endPoints[i - 1].followingControlPointPosition;
                var p2 = endPoints[i].precedingControlPointPosition;
                var p3 = endPoints[i].position;
        ...
        /// 标准Bezier算法四个点和差值获取点
        /// </summary>
        /// <param name="p0">BezierPoint0</param>
        /// <param name="p1">BezierPoint0的followingControlPointPosition</param>
        /// <param name="p2">BezierPoint1的precedingControlPointPosition</param>
        /// <param name="p3">BezierPoint1</param>
        /// <param name="t">0到1</param>
        /// <returns></returns>
